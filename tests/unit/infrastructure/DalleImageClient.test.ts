...
describe('DalleImageClient', () => {
    ...
    describe('Constructor validation', () => {
        it('should throw error when API key is missing', () => {
            expect(() => new DalleImageClient('')).toThrow('Image generation API key is required');
        });

        it('should create client with valid API key', () => {
            const client = new DalleImageClient(apiKey, baseUrl);
    ...
    describe('generateImage() - Success cases', () => {
        it('should return image URL from ImageGen 3 response', async () => {
            const client = new DalleImageClient(apiKey, baseUrl);
        ...
        it('should use ImageGen 3 as the model', async () => {
            const client = new DalleImageClient(apiKey, baseUrl);
