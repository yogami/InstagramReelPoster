...
async function main() {
    ...
    const restaurants: { url: string; category: BusinessCategory }[] = [
        { url: 'https://60secondstonapoli.de/', category: 'restaurant' },
        { url: 'https://burgermeister.berlin', category: 'restaurant' },
        { url: 'https://monsieurvuong.de/', category: 'restaurant' },
        { url: 'https://shisoburger.de/', category: 'restaurant' },
        { url: 'https://standard-pizza.de/', category: 'restaurant' }
    ];

    console.log(`🚀 Starting Generation for ${restaurants.length} Berlin Restaurants...`);
    const results: any[] = [];
